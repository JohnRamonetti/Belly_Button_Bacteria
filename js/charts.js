...
function buildCharts(sample) {
  ...
  d3.json("js/samples.json").then((data) => {
    ...
    var metadata = data.metadata; 
    var metaResults = metadata.filter(sampleObj => sampleObj.id == sample);
    // 2. Create a variable that holds the first sample in the metadata array.
    var metaResult = metaResults[0];
    ...
    var yticks = top_otu_ids.map(id =>'OTU '+ id.toString());
    //console.log(yticks)
    ...
    var gaugeData = [
      {
        domain: { x: [0, 1], y: [0, 1] },
        value: wfreq,
        title:"<b><br><br><br>Belly Button Washing Frequency</b><br>Scrubs Per Week",
        type: "indicator",
        mode: "gauge+number",
        gauge: {
...
// //////////////////////////////////
// //GET RID OF EVERYTHING BELOW THIS
